...
$sn=1;
        ...
        if($count>0){
               ...
               <tr>
                       ...
                       <td>
                       <a href=#" class="btn-primary"><i class="fa fa-key" aria-hidden="true"></i>&nbsp;Change Password</a>       
                       <a href="#" class="btn-secondary"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp;Update admin</a>
                        <a href="#" class="btn-danger"><i class="fa fa-trash" aria-hidden="true"></i>&nbsp;Delete admin</a>
                       </td>
               </tr>
