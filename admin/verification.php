...
?>
 <tr>
                       ...
                       <td>
                       <a href="#" class="btn-secondary"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp;SSC Marksheet</a>
                       <a href="#" class="btn-danger"><i class="fa fa-trash" aria-hidden="true"></i>&nbsp;HSC Marksheet</a>
                       </td>
               </tr>
<?php
